  ...
  return (
    <section className="py-16 px-4 md:px-8 bg-white">
      <div className="max-w-6xl mx-auto">
        <div className="mb-8">
          <span className="text-sm font-mono text-gray-500">&gt; {servicesData.label}</span>
          <hr className="my-2 border-gray-300" />
          <h2 className="text-4xl font-bold text-gray-900">{servicesData.heading}</h2>
        </div>
        ...
        <StackedCards peekHeight={PEEK_HEIGHT} catchSpeed={6} lerpEase={0.08}>
          {SERVICES_DATA.map((service, idx) => {
            ...
            const mutedColor = service.accent ? "rgba(255,255,255,0.8)" : "#4a4a4a";
              ...
              >
                <div className="flex flex-col lg:flex-row">
                  <div className="flex-1 p-8 md:p-12 flex flex-col justify-center">
                    ...
                    <p className="text-lg mb-6" style={{ color: mutedColor }}>{service.description}</p>
